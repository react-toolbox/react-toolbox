...
var _reactTransformHmr2 = (0, _reactTransformHmr4.default)({
  filename: 'components/table/Table.jsx',
...
var Table = _wrapComponent('Table')((_temp2 = _class = function (_React$Component) {
  ...
  _createClass(Table, [{
    ...
    value: function renderHead() {
      if (this.props.heading) {
        ...
        return _react3.default.createElement(_TableHead2.default, {
          model: model,
    ...
    value: function renderBody() {
      ...
      var rows = this.props.source.map(function (data, index) {
        return _react3.default.createElement(_TableRow2.default, {
          data: data,
          index: index,
          key: index,
  ...
  heading: _react3.default.PropTypes.bool,
  ...
  selected: _react3.default.PropTypes.array,
  source: _react3.default.PropTypes.array
}, _class.defaultProps = {
  className: '',
  heading: true,
  selectable: true,
