...
var factory = function factory(Dialog) {
  ...
  TimePickerDialog.propTypes = {
    ...
    theme: _react.PropTypes.shape({
      am: _react.PropTypes.string.isRequired,
      amFormat: _react.PropTypes.string.isRequired,
      ampm: _react.PropTypes.string.isRequired,
      ...
      hoursDisplay: _react.PropTypes.string.isRequired,
      minutes: _react.PropTypes.string.isRequired,
      minutesDisplay: _react.PropTypes.string.isRequired,
      pm: _react.PropTypes.string.isRequired,
      pmFormat: _react.PropTypes.string.isRequired,
      separator: _react.PropTypes.string.isRequired
    }),
