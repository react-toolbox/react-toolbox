...
var rippleFactory = function rippleFactory() {
  ...
  return function (ComposedComponent) {
    var RippledComponent = function (_React$Component) {
    ...
    RippledComponent.propTypes = {
      ...
      onRippleEnded: _react2.default.PropTypes.func,
      ...
      theme: _react2.default.PropTypes.shape({
        ripple: _react2.default.PropTypes.string,
        rippleActive: _react2.default.PropTypes.string,
        rippleRestarting: _react2.default.PropTypes.string,
        rippleWrapper: _react2.default.PropTypes.string
      })
    };
