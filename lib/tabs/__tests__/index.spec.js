...
var _reactTransformHmr2 = (0, _reactTransformHmr4.default)({
  filename: 'components/tabs/__tests__/index.spec.js',
...
describe('Tabs', function () {
  ...
  describe('#render', function () {
    it('does not use fixed by default', function () {
      var tree = _reactAddonsTestUtils2.default.renderIntoDocument(_react3.default.createElement(_Tabs2.default, { theme: _theme2.default }));
    ...
    it('uses fixed when set', function () {
      var tree = _reactAddonsTestUtils2.default.renderIntoDocument(_react3.default.createElement(_Tabs2.default, { theme: _theme2.default, fixed: true }));
      var className = getRenderedClassName(tree, _Tabs.Tabs);
    ...
    it('uses inverse when set', function () {
      var tree = _reactAddonsTestUtils2.default.renderIntoDocument(_react3.default.createElement(_Tabs2.default, { theme: _theme2.default, inverse: true }));
      var className = getRenderedClassName(tree, _Tabs.Tabs);
