...
var _reactTransformHmr2 = (0, _reactTransformHmr4.default)({
  filename: 'components/list/ListItem.jsx',
...
var ListItem = _wrapComponent('ListItem')((_temp2 = _class = function (_React$Component) {
  ...
  _createClass(ListItem, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props, ['onMouseDown', 'to', 'onClick', 'ripple']);

      var children = this.groupChildren();
      var content = _react3.default.createElement(_ListItemLayout2.default, _extends({}, children, other));
      var className = _style2.default.listItem;
      if (this.props.className) className += ' ' + this.props.className;

      return _react3.default.createElement(
        'li',
        { className: className, onClick: this.handleClick, onMouseDown: onMouseDown },
