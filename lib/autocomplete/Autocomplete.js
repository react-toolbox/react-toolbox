    ...
    _createClass(Autocomplete, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            theme = _props.theme,
            other = _objectWithoutProperties(_props, ['allowCreate', 'error', 'label', 'source', 'suggestionMatch', 'selectedPosition', 'showSuggestionsWhenValueIsSet', 'onQueryChange', 'theme']);
