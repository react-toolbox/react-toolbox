...
Overlay.propTypes = {
  ...
  theme: _react2.default.PropTypes.shape({
    ...
    backdrop: _react2.default.PropTypes.string.isRequired,
    invisible: _react2.default.PropTypes.string.isRequired,
    overlay: _react2.default.PropTypes.string.isRequired
  })
};
