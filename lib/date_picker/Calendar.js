...
var _reactTransformHmr2 = (0, _reactTransformHmr4.default)({
  filename: 'components/date_picker/Calendar.jsx',
...
var Calendar = _wrapComponent('Calendar')((_temp2 = _class = function (_React$Component) {
  ...
  _createClass(Calendar, [{
    ...
    value: function renderMonths() {
      ...
      return _react3.default.createElement(
        ...
        _react3.default.createElement(_button.IconButton, { className: _style2.default.prev, icon: 'chevron_left', onClick: this.changeViewMonth.bind(this, 'left', -1) }),
        _react3.default.createElement(_button.IconButton, { className: _style2.default.next, icon: 'chevron_right', onClick: this.changeViewMonth.bind(this, 'right', 1) }),
  ...
  display: _react3.default.PropTypes.oneOf(['months', 'years']),
