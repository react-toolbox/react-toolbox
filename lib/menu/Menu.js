...
var factory = function factory(MenuItem) {
  ...
  Menu.propTypes = {
    ...
    theme: _react2.default.PropTypes.shape({
      ...
      bottomLeft: _react2.default.PropTypes.string.isRequired,
      bottomRight: _react2.default.PropTypes.string.isRequired,
      menu: _react2.default.PropTypes.string.isRequired,
      menuInner: _react2.default.PropTypes.string.isRequired,
      outline: _react2.default.PropTypes.string.isRequired,
      rippled: _react2.default.PropTypes.string.isRequired,
      static: _react2.default.PropTypes.string.isRequired,
      topLeft: _react2.default.PropTypes.string.isRequired,
      topRight: _react2.default.PropTypes.string.isRequired
    })
  };
  Menu.defaultProps = {
    active: false,
