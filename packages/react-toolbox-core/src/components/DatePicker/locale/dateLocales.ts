...
export default function getLocaleObject(
  locale: keyof Locales | Locale,
): Locale {
  return typeof locale === 'string' ? locales[locale] : locales.en;
}
...
export const locales: Locales = {
  ...
  ua: {
    ...
    monthsShort: 'Січ_Лют_Берез_Квіт_Трав_Черв_Лип_Серп_Верес_Жовт_Листоп_Груд'.split(
      '_',
    ),
