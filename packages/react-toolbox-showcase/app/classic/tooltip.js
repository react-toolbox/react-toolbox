...
import Tooltip, { tooltipFactory } from 'react-toolbox/src/components/tooltip';
import Chip from 'react-toolbox/src/components/chip';
import Avatar from 'react-toolbox/src/components/avatar';
...
const TooltipTest = () => (
  <section>
    ...
    <TooltipButton
      ...
      floating
      disabled
      tooltip="Floating can not be shown"
    />
    <TooltipButton
      icon="add"
      floating
    ...
    <p>
      ...
      {' '}
      <TooltipStrong tooltip="This is a auto show tooltip">
        consectetur
      </TooltipStrong>
      {' '}
      adipiscing elit.
    ...
    <p>
      ...
      {' '}
      <TooltipStrongDirect
        tooltip="This is a auto show tooltip"
        tooltipShowOnClick
      >
        oh hai
      </TooltipStrongDirect>
