...
import {
  ...
  TableRow,
  TableCell,
} from 'react-toolbox/src/components/table';
import Tooltip from 'react-toolbox/src/components/tooltip';
...
class TableTest extends Component {
  ...
  getSortedData = () => {
    const compare = this.state.sorted === 'asc'
      ? sortByCaloriesAsc
      : sortByCaloriesDesc;
      ...
      <section>
        ...
        >
          <TableHead>
            ...
            <TableCell onClick={this.handleSortClick} numeric sorted={sorted}>
              Calories
            </TableCell>
