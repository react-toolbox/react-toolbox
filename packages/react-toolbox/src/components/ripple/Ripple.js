  ...
  return ComposedComponent => {
    class RippledComponent extends Component {
      ...
      componentDidUpdate(prevProps, prevState) {
        ...
        if (
          Object.keys(prevState.ripples).length <
       ...
       */
      getDescriptor(x, y) {
        const { left, top, height, width } = ReactDOM.findDOMNode(
          this
      ...
      addRippleDeactivateEventListener(isTouch, rippleKey) {
        ...
        const endRipple = this.createRippleDeactivateCallback(
          eventType,
          rippleKey
        );
      ...
      render() {
        ...
        return !ripple
          ...
          : React.createElement(ComposedComponent, finalProps, [
              children,
              childRipples,
            ]);
      }
