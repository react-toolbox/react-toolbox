  ...
  <article>
    <header className={style.header}>
      <div className={style.github}>
        ...
        />
        <iframe
          src="https://ghbtns.com/github-btn.html?user=react-toolbox&amp;repo=react-toolbox&amp;type=fork&amp;count=true"
          frameBorder="0"
          scrolling="0"
        />
    ...
    <section className={style.content}>
      <p>
        React Toolbox is a set of React components that implements Google Material Design
        specification. It's built on top of some the trendiest proposals like CSS Modules (written
        in SASS), Webpack and ES6. The library harmoniously integrates with your Webpack workflow
        and it's easily customizable and very flexible.
      </p>

      <p>
        Check our awesome documentation (which is built using React Toolbox) and try all the
        components with live examples. We've created a playground so you don't need to install
        anything to fall in love with our components, so fun!
      </p>
    ...
    <section className={`${style.content}`}>
      ...
      <ul className={style.authors}>
        <Card className={style.author}>
          ...
          <CardText>
            Software gardener • Film, music & comic lover • Frontend Engineer at Audiense • Any
            biographer in the room?
          </CardText>
          <CardActions>
            <Button href="http://github.com/javivelasco" target="_blank">
              <GithubIcon /> Github
            </Button>
            <Button
        ...
        <Card className={style.author}>
          ...
          <CardText>
            Creative Doer · A complicated #human who builds stuff · #author · #opensource lover ·
            #traveller · with a dark past being CEO & CTO
          </CardText>
          <CardActions>
            <Button href="http://github.com/soyjavi" target="_blank">
              <GithubIcon /> Github
            </Button>
            <Button
    ...
    <footer className={style.footer}>
      ...
      <small>
        Crafted with <span className={style.love}>ღ</span> between Spain and Thailand
      </small>
    </footer>
  </article>;
