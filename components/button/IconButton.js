...
const RawIconButton = themr('ToolboxButton')(IconButton);
export default themr('ToolboxButton')(Ripple({centered: true})(IconButton));
export { RawIconButton as RawIconButton };
