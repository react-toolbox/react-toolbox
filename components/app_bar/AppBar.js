  ...
  class AppBar extends React.Component {
    static propTypes = {
      ...
      theme: PropTypes.shape({
        appBar: PropTypes.string, // eslint-disable-line react/no-unused-prop-types
    ...
    render() {
      const { children, leftIcon, onLeftIconClick, onRightIconClick,
        rightIcon, theme, title } = this.props;
