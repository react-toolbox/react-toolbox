  ...
  render() {
    return (
      <section>
        ...
        <Input type="text" name="withError" value={this.state.withError} label="With error (type error to trigger)" onChange={this.handleChange} error={this.state.withError === 'error' && 'Test error!'} />
      </section>
    );
  }
}
