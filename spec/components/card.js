...
const cards = {
  basic: [
    ...
    },
    {
      ...
      component: (
        <Card className={style.card}>
          <CardTitle title={<u>Title component</u>} subtitle={<u>Subtitle component</u>} />
          <CardText>
            {dummyText}
          </CardText>
          <CardActions>
  ...
  media: [
    {
      ...
      component: (
        <Card className={style.card}>
          <CardMedia aspectRatio="wide" className={style.primary}>
      ...
      component: (
        <Card className={style.card}>
          <div className={style.cardRow}>
            <CardTitle title="Title goes here" subtitle="Subtitle here" />
            <CardMedia className={style.media} image="https://placeimg.com/400/400/nature" />
          </div>
          <CardActions>
            <Button label="Action 1" />
            <Button label="Action 2" />
    ...
    },
    {
      ...
      component: (
        <Card>
          <div className={style.cardRow}>
            <CardTitle title="Title goes here" subtitle="Subtitle here" />
            <CardMedia className={style.mediaLarge} image="https://placeimg.com/400/400/nature" />
          </div>
        </Card>
      ),
    },
  ...
  small: [
    {
      ...
      component: (
        <Card>
          <CardMedia aspectRatio="square" image="https://placeimg.com/400/400/nature">
